...
export default (props) => {
    ...
    const handleSubmit = (props) => {
        ...
        if (props.location.address == null) {
            Axios.post(`${BASE_URL}/address/`, address, { headers: { Authorization: `Token ${ctx.state.accessToken}` } }).then(response => {
            ...
            Axios.put(`${BASE_URL}/address/${address.id}/`, address, { headers: { Authorization: `Token ${ctx.state.accessToken}` } }).then(response => {
                enqueueSnackbar("Address saved");
                history.replace({ pathname: "/chooseAddress", from: props.location.from })
            }
            ).catch(error => {
